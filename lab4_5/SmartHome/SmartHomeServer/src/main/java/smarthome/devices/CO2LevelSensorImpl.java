...
import SmartHomeIce.CO2LevelSensor;
import SmartHomeIce.InStandbyModeError;
import com.zeroc.Ice.Current;
import smarthome.server.Helper;
...
public class CO2LevelSensorImpl extends SmartDeviceImpl implements CO2LevelSensor {
    ...
    @Override
    public int getCO2LevelInPPM(Current current) throws InStandbyModeError {
    ...
    @Override
    public boolean isCO2LevelSafe(Current current) throws SmartHomeIce.InStandbyModeError {
